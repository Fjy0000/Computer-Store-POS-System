        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="http://localhost/Computer-Store-POS-System/administration/crud_staff/staff_view.php?id=<?php echo $_SESSION['id'];?>">User's Profile</a></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li><a class="dropdown-item" href="http://localhost/Computer-Store-POS-System/administration/logout_staff.php">Logout</a></li>
                </ul>
            </li>
        </ul>
    </form>
